...
//        parseModel(camelModel, paasageConfiguration);
...
//    }
//
//    public void parseModel(CamelModel camelModel, PaasageConfiguration paasageConfiguration) {
...
//
//        parseDeploymentModel(deploymentModel, paasageConfiguration, preferedProviders);
//
////        storeRelatedProviderModels(deploymentModel, paasageConfiguration);
//
...
//    }
//
//    private void parseDeploymentModel(DeploymentModel deploymentModel, PaasageConfiguration paasageConfiguration, Set<String> preferedProviders) {
//
//        createVirtualMachines(deploymentModel, paasageConfiguration, preferedProviders);
//        createApplicationComponents(deploymentModel, paasageConfiguration);
//
//
...
//    }
//
//    private void createVirtualMachines(DeploymentModel deploymentModel, PaasageConfiguration paasageConfiguration, Set<String> preferedProviders) {
...
//
//        boolean addNewCandidates = paasageConfiguration.getProviders().size()==0;
//
...
//
//
//    private void createApplicationComponents(DeploymentModel deploymentModel, PaasageConfiguration paasageConfiguration) {
...
//        paasageConfiguration.getComponents().addAll(parseComponentInstances(componentInstances));
//
//        log.info("**		Parsing Components");
//        paasageConfiguration.getComponents().addAll(parseComponents(components, componentInstances, requirements));
//    }
//
...
//    }
//
//    private void parseVMInstances(List<VMInstance> vms, PaasageConfiguration paasageConfiguration, boolean addNewCandidates, VMRequirementSet globalVMRequirements, Set<String> preferedProviders) {
//
//        for (VMInstance vmInstance : vms) {
//            log.info("**			Parsing VM Instance: " + vmInstance.getName());
//
//            Optional<VirtualMachineProfile> virtualMachineProfileOpt = paasageConfigurationUtilsService.searchVMProfileById(paasageConfiguration.getVmProfiles(), vmInstance.getName());
//
...
//                paasageConfiguration.getVms().add(instance);
