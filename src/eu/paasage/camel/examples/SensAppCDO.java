...
public class SensAppCDO {
	...
	public static EObject getSensAppCamelModel() {
		...
		ProviderModel providerModel = ProviderFactory.eINSTANCE
				.createProviderModel();
		providerModel.setName("Provider_Model");
		...
		amazonOrgModel.setName("Amazon_Organisation_Model");
		...
		amazonEuDataCenter.setName("European_Amazon_Data_Centre");
		...
		OrganisationModel flexiantOrgModel = OrganisationFactory.eINSTANCE
				.createOrganisationModel();
		flexiantOrgModel.setName("Flexiant_Organisation_Model");
		...
		flexiantEuDataCenter.setName("Flexiant_Data_Centre");
		...
		OrganisationModel sintefOrgModel = OrganisationFactory.eINSTANCE
				.createOrganisationModel();
		sintefOrgModel.setName("SINTEF_Organisation_Model");
		...
		sintefNovaProvider.setName("Sintef_Nova");
		...
		sintefDataCenter.setName("Sintef_Nova_Data_Centre");
		...
		rm.setName("SensAPP_Requirement_Model");
		...
		scalabilityModel.setName("SensApp_Scalability_Model");
		
		MetricModel metricModel = MetricFactory.eINSTANCE
				.createMetricModel();
		metricModel.setName("SensApp_Metric_Model");
		...
		execTime.setName("Execution_Time");
		...
		rawEtMetricRange.setName("RAWExecutionTimeRange");
		...
		avgEtMetricRange.setName("AVGExecutionTimeRange");
		...
		rawStorageMetricRange.setName("RAWStorageRange");
		...
		execModel.setName("SensApp_Execution_Model");
		...
		user1RG.setName("SensAppPoliciesRequirementGroup");
