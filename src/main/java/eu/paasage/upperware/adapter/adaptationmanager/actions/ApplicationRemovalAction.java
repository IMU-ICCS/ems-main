...
public class ApplicationRemovalAction implements Action {
	...
	public ApplicationRemovalAction(String NameOfApp) {
		this.appName = NameOfApp;
	}

	private static final Logger LOGGER = Logger
			.getLogger(ApplicationRemovalAction.class.getName());
	...
	public void execute(Map<String, Object> input, Map<String, Object> output) throws ActionError {
		...
		try {
			applicationId = execInterfacer.removeApplication(appName);
		} catch (Exception e) {
