...
public class SingleFactory {
    ...
    public static MetricComponentBinding getOrCreateNewMetricComponentBinding(CamelModel model, ExecutionContext ec, EList<EObject> resourceContents, ComponentInstance instance, VMInstance vm, Application app){
        /* TODO Dangerous casting */
        if(resourceContents != null) {
            for (MetricObjectBinding metricObjectBinding : model.getMetricModels().get(0).getBindings()) {
        ...
        mcb.setName("Bind_with_" + (instance!=null?instance.getName():"NO_CMP") + '_' + (vm!=null?vm.getName():"NO_VM"));
        mcb.setVmInstance(vm);
        mcb.setComponentInstance(instance);
        mcb.setExecutionContext(ec);
        if(resourceContents != null) resourceContents.add(mcb);
    ...
    public static MetricVMBinding getOrCreateNewMetricVMBinding(CamelModel model, ExecutionContext ec, EList<EObject> resourceContents, VMInstance vm, Application app){
        /* TODO Dangerous casting */
        if(resourceContents != null) {
        ...
        if(resourceContents != null) resourceContents.add(mvb);
    ...
    public static MetricApplicationBinding getOrCreateNewMetricApplicationBinding(CamelModel model, ExecutionContext ec, EList<EObject> resourceContents, Application app){
        /* TODO Dangerous casting */
        if(resourceContents != null) {
            for (MetricObjectBinding metricBinding : model.getMetricModels().get(0).getBindings()) {
                if (metricBinding instanceof MetricApplicationBinding) {
                    MetricApplicationBinding metricAppBinding = (MetricApplicationBinding) metricBinding;
        ...
        if(resourceContents != null) resourceContents.add(mab);
    ...
    public static Schedule getOrCreateFixedSchedule(CamelModel model, EList<EObject> resourceContents, int interval, TimeIntervalUnit timeIntervalUnit, String name, ScheduleType scheduleType){
        /* TODO Dangerous casting */
        if(resourceContents != null) {
        ...
        if(resourceContents != null) resourceContents.add(schedule);
        model.getMetricModels().get(0).getSchedules().add(schedule);

        return schedule;
    }

    public static Window getOrCreateWindow(CamelModel model, EList<EObject> resourceContents, int measurementSize, int timeSize, WindowType windowType, TimeIntervalUnit timeIntervalUnit, String name, WindowSizeType windowSizeType){
        /* TODO Dangerous casting */
        if(resourceContents != null) {
        ...
        if(resourceContents != null) resourceContents.add(window);
    ...
    public static TimeIntervalUnit getOrCreateTimeIntervalUnit(EList<EObject> resourceContents, UnitType unitType, UnitDimensionType unitDimensionType, String name){
        /* TODO Dangerous casting */
        if(resourceContents != null) {
            for (EObject obj : resourceContents) {
        ...
        unit.setName(name);
        if(resourceContents != null) resourceContents.add(unit);
