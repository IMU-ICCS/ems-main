 ...
 *   <li>{@link camel.deployment.Communication#getOfDataObject <em>Of Data Object</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Communication extends CloudMLElement {
	...
	/**
	 * Returns the value of the '<em><b>Of Data Object</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Of Data Object</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Of Data Object</em>' reference.
	 * @see #setOfDataObject(DataObject)
	 * @see camel.deployment.DeploymentPackage#getCommunication_OfDataObject()
	 * @model
	 * @generated
	 */
	DataObject getOfDataObject();

	/**
	 * Sets the value of the '{@link camel.deployment.Communication#getOfDataObject <em>Of Data Object</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Of Data Object</em>' reference.
	 * @see #getOfDataObject()
	 * @generated
	 */
	void setOfDataObject(DataObject value);
