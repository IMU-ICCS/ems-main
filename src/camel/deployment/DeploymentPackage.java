...
public interface DeploymentPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int COMMUNICATION__DATA_OBJECT = CLOUD_ML_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int HOSTING_PORT__COMPONENT = CLOUD_ML_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PROVIDED_HOST__COMPONENT = HOSTING_PORT__COMPONENT;
	 ...
	 * @ordered
	 */
	int REQUIRED_HOST__COMPONENT = HOSTING_PORT__COMPONENT;
	 ...
	 * @ordered
	 */
	int HOSTING_PORT_INSTANCE__COMPONENT_INSTANCE = CLOUD_ML_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PROVIDED_HOST_INSTANCE__COMPONENT_INSTANCE = HOSTING_PORT_INSTANCE__COMPONENT_INSTANCE;
	 ...
	 * @ordered
	 */
	int REQUIRED_HOST_INSTANCE__COMPONENT_INSTANCE = HOSTING_PORT_INSTANCE__COMPONENT_INSTANCE;
	...
	/**
	 * Returns the meta object for the reference '{@link camel.deployment.Communication#getDataObject <em>Data Object</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Data Object</em>'.
	 * @see camel.deployment.Communication#getDataObject()
	 * @see #getCommunication()
	 * @generated
	 */
	EReference getCommunication_DataObject();
	...
	/**
	 * Returns the meta object for the reference '{@link camel.deployment.HostingPort#getComponent <em>Component</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Component</em>'.
	 * @see camel.deployment.HostingPort#getComponent()
	 * @see #getHostingPort()
	 * @generated
	 */
	EReference getHostingPort_Component();
	...
	/**
	 * Returns the meta object for the reference '{@link camel.deployment.HostingPortInstance#getComponentInstance <em>Component Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Component Instance</em>'.
	 * @see camel.deployment.HostingPortInstance#getComponentInstance()
	 * @see #getHostingPortInstance()
	 * @generated
	 */
	EReference getHostingPortInstance_ComponentInstance();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference COMMUNICATION__DATA_OBJECT = eINSTANCE.getCommunication_DataObject();
		 ...
		 * @generated
		 */
		EReference HOSTING_PORT__COMPONENT = eINSTANCE.getHostingPort_Component();
		 ...
		 * @generated
		 */
		EReference HOSTING_PORT_INSTANCE__COMPONENT_INSTANCE = eINSTANCE.getHostingPortInstance_ComponentInstance();
