 ...
 * @generated
 */
public class CerifSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CerifPackage.CERIF_MODEL: {
				CerifModel cerifModel = (CerifModel)theEObject;
				T result = caseCerifModel(cerifModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CerifPackage.USER: {
			...
			case CerifPackage.ORGANIZATION: {
			...
			case CerifPackage.ALLOWED_ACTIONS: {
				AllowedActions allowedActions = (AllowedActions)theEObject;
				T result = caseAllowedActions(allowedActions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CerifPackage.EXTERNAL_IDENTIFIER: {
				ExternalIdentifier externalIdentifier = (ExternalIdentifier)theEObject;
				T result = caseExternalIdentifier(externalIdentifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CerifPackage.DATA_CENTER: {
				DataCenter dataCenter = (DataCenter)theEObject;
				T result = caseDataCenter(dataCenter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CerifPackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CerifPackage.ENTITY: {
				Entity entity = (Entity)theEObject;
				T result = caseEntity(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CerifPackage.CREDENTIALS: {
	 ...
	 * @generated
	 */
	public T caseCerifModel(CerifModel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Allowed Actions</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Allowed Actions</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAllowedActions(AllowedActions object) {
		return null;
	}
