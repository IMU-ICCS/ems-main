 ...
 *   <li>{@link camel.impl.VMInfoImpl#getCloudIndependentVMInfo <em>Cloud Independent VM Info</em>}</li>
...
public class VMInfoImpl extends CDOObjectImpl implements VMInfo {
	 ...
	 * @generated
	 */
	public CloudIndependentVMInfo getCloudIndependentVMInfo() {
		return (CloudIndependentVMInfo)eGet(CamelPackage.Literals.VM_INFO__CLOUD_INDEPENDENT_VM_INFO, true);
	}
	 ...
	 * @generated
	 */
	public void setCloudIndependentVMInfo(CloudIndependentVMInfo newCloudIndependentVMInfo) {
		eSet(CamelPackage.Literals.VM_INFO__CLOUD_INDEPENDENT_VM_INFO, newCloudIndependentVMInfo);
	}
