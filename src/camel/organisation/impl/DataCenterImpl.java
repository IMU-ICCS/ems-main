 ...
 * <ul>
 *   <li>{@link camel.organisation.impl.DataCenterImpl#getName <em>Name</em>}</li>
 *   <li>{@link camel.organisation.impl.DataCenterImpl#getCodeName <em>Code Name</em>}</li>
 *   <li>{@link camel.organisation.impl.DataCenterImpl#getHasLocation <em>Has Location</em>}</li>
 *   <li>{@link camel.organisation.impl.DataCenterImpl#getOfCloudProvider <em>Of Cloud Provider</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataCenterImpl extends CDOObjectImpl implements DataCenter {
	...
	public Location getHasLocation() {
		return (Location)eGet(OrganisationPackage.Literals.DATA_CENTER__HAS_LOCATION, true);
	}
	...
	public void setHasLocation(Location newHasLocation) {
		eSet(OrganisationPackage.Literals.DATA_CENTER__HAS_LOCATION, newHasLocation);
	}
	...
	public CloudProvider getOfCloudProvider() {
		return (CloudProvider)eGet(OrganisationPackage.Literals.DATA_CENTER__OF_CLOUD_PROVIDER, true);
	}
	...
	public void setOfCloudProvider(CloudProvider newOfCloudProvider) {
		eSet(OrganisationPackage.Literals.DATA_CENTER__OF_CLOUD_PROVIDER, newOfCloudProvider);
	}
