 ...
 * <ul>
 *   <li>{@link camel.organisation.impl.ExternalIdentifierImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link camel.organisation.impl.ExternalIdentifierImpl#getName <em>Name</em>}</li>
 *   <li>{@link camel.organisation.impl.ExternalIdentifierImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExternalIdentifierImpl extends CDOObjectImpl implements ExternalIdentifier {
	...
	public String getName() {
		return (String)eGet(OrganisationPackage.Literals.EXTERNAL_IDENTIFIER__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(OrganisationPackage.Literals.EXTERNAL_IDENTIFIER__NAME, newName);
	}
