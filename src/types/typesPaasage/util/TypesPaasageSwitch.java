...
public class TypesPaasageSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TypesPaasagePackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = casePaaSageCPElement(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TypesPaasagePackage.CONTINENT: {
				Continent continent = (Continent)theEObject;
				T result = caseContinent(continent);
				if (result == null) result = caseLocation(continent);
				if (result == null) result = casePaaSageCPElement(continent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TypesPaasagePackage.COUNTRY: {
				Country country = (Country)theEObject;
				T result = caseCountry(country);
				if (result == null) result = caseLocation(country);
				if (result == null) result = casePaaSageCPElement(country);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TypesPaasagePackage.CITY: {
				City city = (City)theEObject;
				T result = caseCity(city);
				if (result == null) result = caseLocation(city);
				if (result == null) result = casePaaSageCPElement(city);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
