...
public class TypesPaasageFactoryImpl extends EFactoryImpl implements TypesPaasageFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TypesPaasagePackage.CONTINENT: return (EObject)createContinent();
			case TypesPaasagePackage.COUNTRY: return (EObject)createCountry();
			case TypesPaasagePackage.CITY: return (EObject)createCity();
