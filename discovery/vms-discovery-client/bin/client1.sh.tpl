...
sudo ./mule start -M-Dhost.broker="tcp://BROKER_IP_ADDR:BROKER_PORT"  "-M-Dhost.rule=select\ avg\(metricValue\)\ as\ metricValue,\ vmName\ as\ vmName,\ cloudName\ as\ cloudName,\ componentName\ as\ componentName,\ 1\ as\ level,\ current_timestamp\ as\ timestamp\ from\ Visor_event_second.win:time\(60\ sec\)\ where\ metricValue\ is\ not\ null\ output\ last\ every\ 60\ sec"
sleep 2
