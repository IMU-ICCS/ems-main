...
/*
 * A task to configure an internal component instance in the cloud application.
 * <p> 
...
public class ComponentInstanceTask extends ConfigurationTask {
	 ...
	 */
	public ComponentInstanceTask(String iname, TaskType theType) {
		super(iname, theType);
		LOGGER.info("setting task name to component instance name : "  + iname + " task type to " + theType.toString() + "...");		 
	}
}
