 ...
 */
public class VMTypeTask extends ConfigurationTask {

	/** Message logger */
	private static final Logger LOGGER = Logger.getLogger(VMTypeTask.class);
	/**
	 * @param iname		the {@link eu.paasage.camel.deployment.VM <em>VM</em>} name
	 * @param theType  	the {@link TaskType <em>TaskType</em>}
	 */
	public VMTypeTask(String iname, TaskType theType) {
		super(iname, theType);
		LOGGER.info("setting task name to VM type name : "  + iname + " task type : " + theType.toString() + "...");		 
