...
/**
 * Error associated with comparing two {@link eu.paasage.camel.deployment.DeploymentModel <em>DeploymentModel</em>} objects.
 * <p>
 * @author Shirley Crompton
 * org     Science and Technology Facilities Council
 */
public class ModelComparatorException extends Exception {
	/**
	 ...
	 */
	public ModelComparatorException(String message) {
		super(message);
	}
	 ...
	 */
	public ModelComparatorException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause {@link Throwable} cause
	 */
	public ModelComparatorException(Throwable cause) {
		super(cause);
	}
