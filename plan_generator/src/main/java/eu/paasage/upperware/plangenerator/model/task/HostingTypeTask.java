...
/**
 * A task to configure a hosting between components in the cloud application.
 * <p> 
 ...
 */
public class HostingTypeTask extends ConfigurationTask {

	/** Message logger */
	private static final Logger LOGGER = Logger.getLogger(HostingTypeTask.class);
	/**
	/* Construct an instance
	 * <p>
	 * @param iname	the hosting name
	 * @param theType the {@link TaskType <em>TaskType</em>}
	 */
	public HostingTypeTask(String iname, TaskType theType) {
		super(iname, theType);
