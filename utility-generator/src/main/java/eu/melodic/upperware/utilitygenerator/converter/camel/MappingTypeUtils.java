...
public class MappingTypeUtils {
    ...
    public static NodeCandidatesAttributesType getNodeCandidateAttributeType(MetricVariableImpl metric){
    ...
    public static boolean hasTypeOfVariable(MetricVariableImpl metric){
    ...
    public static boolean hasTypeOfNodeCandidateAttribute(MetricVariableImpl metric){
