...
import eu.melodic.upperware.utilitygenerator.CostEvaluatorExampleV2
...
class SimpleTestSecondVersion extends Specification{
  ...
  def setup(){
    ...
    costEvaluator = new CostEvaluatorExampleV2(true)
  }
