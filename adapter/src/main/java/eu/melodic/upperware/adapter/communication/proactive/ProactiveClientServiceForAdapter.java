...
public interface ProactiveClientServiceForAdapter extends IProactiveClientServiceConnector {
    ...
    int addByonNodes(Map<String, Pair<String, String>> byonIdPerComponent, String jobId);
    ...
    int addEdgeNodes(Map<String, Pair<String,String>> edgeIdPerComponent, String jobId);
