 ...
 * <ul>
 *   <li>{@link eu.paasage.upperware.metamodel.types.typesPaasage.impl.LocationsImpl#getLocations <em>Locations</em>}</li>
 * </ul>
 * </p>
 *
 * 
...
public class LocationsImpl extends CDOObjectImpl implements Locations {
	...
	public EList<LocationUpperware> getLocations() {
		return (EList<LocationUpperware>)eGet(TypesPaasagePackage.Literals.LOCATIONS__LOCATIONS, true);
	}
