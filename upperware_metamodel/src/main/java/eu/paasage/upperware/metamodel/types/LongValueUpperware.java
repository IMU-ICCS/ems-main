...
public interface LongValueUpperware extends NumericValueUpperware {
	 ...
	 * @see #setValue(long)
	 * @see eu.paasage.upperware.metamodel.types.TypesPackage#getLongValueUpperware_Value()
	 * @model required="true"
	 * @generated
	 */
	long getValue();
	...
	/**
	 * Sets the value of the '{@link eu.paasage.upperware.metamodel.types.LongValueUpperware#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
