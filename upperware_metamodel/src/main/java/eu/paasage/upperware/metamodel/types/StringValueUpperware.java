...
public interface StringValueUpperware extends ValueUpperware {
	 ...
	 * @see #setValue(String)
	 * @see eu.paasage.upperware.metamodel.types.TypesPackage#getStringValueUpperware_Value()
	 * @model required="true"
	 * @generated
	 */
	String getValue();
	...
	/**
	 * Sets the value of the '{@link eu.paasage.upperware.metamodel.types.StringValueUpperware#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
