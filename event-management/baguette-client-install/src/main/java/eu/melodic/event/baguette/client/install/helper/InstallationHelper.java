...
public interface InstallationHelper {
    Optional<List<String>> getInstallationInstructionsForOs(Map<String,Object> nodeMap, Map<String,String> contextMap, BaguetteServer baguette) throws IOException;
