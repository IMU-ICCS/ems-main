...
import eu.melodic.event.brokerutil.BrokerUtil;
import lombok.Data;
...
public class EventGenerator implements Runnable {
	...
	public void run() {
		...
		String brokerUrl = brokerUtil.getBrokerProperties().getBrokerUrl();
		...
		while (keepRunning) {
			try {
				...
				brokerUtil.publishEvent( brokerUrl, topicName, event );
