...
public class BrokerCepFakeEventsProducer {
	...
	public static interface PayloadGenerator {
		public default String payloadAsString(int iteration) { Object o = payloadAsObject(iteration); return (o!=null ? o.toString() : null); }
		public default Object payloadAsObject(int iteration) { return null; }
	}
	
	public static class PayloadMap extends HashMap<String,Object> {
		public static PayloadMap create() { return new PayloadMap(); }
		public PayloadMap put(String key, Object value) { super.put(key, value); return this; }
	}
}