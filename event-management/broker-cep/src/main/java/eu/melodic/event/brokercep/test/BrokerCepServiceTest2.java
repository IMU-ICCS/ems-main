...
public class BrokerCepServiceTest2 implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            generator1.sendEvents("TemperatureEvent", new PayloadGenerator() {
            ...
            generator2.sendEvents("RadiationEvent", new PayloadGenerator() {
                public Object payloadAsObject(int it) {
                    return PayloadMap.create()
            ...
            generator3.sendEvents("WindEvent", new PayloadGenerator() {
                public Object payloadAsObject(int it) {
                    return PayloadMap.create()
    ...
    protected void registerEplStatements() {
        ...
        cepService.addStatementSubscriber(new StatementSubscriber() {
            ...
            public String getName() {
                return "CriticalEventSubscriber";
            }
