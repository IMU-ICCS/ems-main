...
public class CepEvalFunction {
	...
	protected static double _eval(String formula, String streamNames, Map... maps) {
		...
		if (names.length!=maps.length) throw new IllegalArgumentException("The num. of stream names provided is not equal to the num. of values provided");
	...
	public static double eval(String formula, String streamNames, double... v) {
		...
		String[] names = streamNames.split(",");
		if (names.length!=v.length) throw new IllegalArgumentException("The num. of stream names provided is not equal to the num. of values provided");
		Map<String,Double> args = new HashMap<>();
