    ...
    private List<Deployment> createDeploymentsList(List<org.ow2.proactive.sal.model.Deployment> deployments) {
        ...
        return deployments.stream()
                .map(deployment -> Deployment.builder()
                        ...
                        .locationName(deployment.getNode().getNodeCandidate().getLocation().getName())
                        .imageProviderId(deployment.getNode().getNodeCandidate().getImage().getProviderId())
                        .hardwareProviderId(deployment.getNode().getNodeCandidate().getHardware().getProviderId())
