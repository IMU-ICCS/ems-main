...
import eu.paasage.upperware.metamodel.cp.impl.CpVariableImpl;
...
class NCSolverCoordinatorTest {
    ...
    public void simpleOneComponentTest() {
        ...
        NCSolverCoordinator ncSolverCoordinator = new NCSolverCoordinator(1, 10, 10, data.keySet().iterator().next(),
                data.values().iterator().next(), nc);
        PTSolution solution = ncSolverCoordinator.solve(new MaxRuntime(10, TimeUnit.SECONDS));
