...
class CPWrapperTest {
    ...
    public void isFeasibleTest() {
        assertFalse( cpWrapper.checkIfFeasible(Arrays.asList(new Integer[] {0, 0, 0})));

        assertFalse( cpWrapper.checkIfFeasible(Arrays.asList(new Integer[] {0, 0, 2})));

        assertTrue( cpWrapper.checkIfFeasible(Arrays.asList(new Integer[] {2, 0, 2})));
    }
