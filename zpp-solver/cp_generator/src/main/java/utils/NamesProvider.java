...
import nc_solver.variable_orderer.*;
...
public class NamesProvider {
    ...
    public static String getVariableName(Integer var) {
        ...
        return getComponentName(component) + "_" + variableTypeToString(mapIndexToType(var % ComponentVariableOrderer.VARIABLES_PER_COMPONENT));
    }
}
