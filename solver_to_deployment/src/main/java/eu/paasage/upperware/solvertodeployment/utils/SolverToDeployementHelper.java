...
public class SolverToDeployementHelper {
	...
	public static EList<InternalComponentInstance> createInternalComponentInstance(String componentName, DeploymentModel deploymentModel, int nb) throws S2DException {
		InternalComponent internalComponent = findInternalComponent(deploymentModel, componentName);
		return IntStream.range(0, nb)
				.mapToObj(value -> CloudMLHelper.createICInstance(internalComponent))
				.collect(Collectors.toCollection(BasicEList::new));
	}

	public static InternalComponent findInternalComponent(DeploymentModel deploymentModel, String componentName) throws S2DException {
