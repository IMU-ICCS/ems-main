...
//
//					try {
//						EList<InternalComponentInstance> internalComponentInstanceToRegisters = SolverToDeployementHelper.createSoftwareComponentInstance(componentName, deploymentModel, cardinality);
...
////
////		try {
//			CDODatabaseProxy2.getLastDeployedTypeModel(camelModelID, transaction).ifPresent(deployedModel -> {
//				//1. VMInstances
