...
public class PaaSagePropertyManager 
{
     ...
     */
    public static Map loadPropertyFile(String propertyFile)
    {
    ...
    public void loadPropertyFiles()
    {
    	...
    	s2dProperties= loadPropertyFile("wp3_s2d.properties"); 
    }
    
    /**
     * Retrieves a property related to S2D
     * @param key The property key 
     * @return The property value
     */
    public String getS2DProperty(String key)
    {
    	return (String) s2dProperties.get(key); 
    }
    
    
    public void addS2DProperty(String key, String value)
    {
    	s2dProperties.put(key, value);
    }
