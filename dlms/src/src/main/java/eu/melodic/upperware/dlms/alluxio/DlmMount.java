...
/**
 * reads data from S3 and writes data to HDFS.
 *
 * NOTE: This example assumes that the existence of an Alluxio cluster, the
 * existence of an HDFS cluster, and that the properties for accessing S3 are
 * set in your Alluxio configuration.
 *
 * If the above assumptions are met, you can run the example using:
 *
 * ./bin/alluxio runClass alluxio.examples.MultiMount <HDFS_URL>
 */
public final class DlmMount {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Open the output stream, setting the write type to make sure result is
			// persisted.
