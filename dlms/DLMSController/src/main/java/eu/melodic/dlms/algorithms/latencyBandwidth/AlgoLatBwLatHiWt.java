...
public class AlgoLatBwLatHiWt {
	...
	public AlgoLatBwLatHiWt(DataCenterRepository dataCenterRepository,
	...
	private boolean computeLatestHigher(Long dc1Id, Long dc2Id) {
		...
		case "numRecords":
			...
			break;
		default:
			LOGGER.info("Sorry the function has not been implemented yet!");
		}
	...
	private void computeLatestHigherWeight(List<DataCenterLatencyBandwidth> dataCenterList, Long dc1Id, Long dc2Id) {
