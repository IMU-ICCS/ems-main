...
/**
 * Run:
 * java -cp .\target\control-service.jar  -Dloader.main=eu.melodic.event.control.util.jwt.JwtTokenUtil -Dlogging.level.ROOT=WARN -Dlogging.level.eu.melodic.event.util=ERROR org.springframework.boot.loader.PropertiesLauncher createKey
 * -or-
 * java -cp .\target\control-service.jar  -Dloader.main=eu.melodic.event.control.util.jwt.JwtTokenUtil -Dlogging.level.ROOT=WARN -Dlogging.level.eu.melodic.event.util=ERROR org.springframework.boot.loader.PropertiesLauncher create [USER]?
 * -or-
 * java -cp .\target\control-service.jar  -Dloader.main=eu.melodic.event.control.util.jwt.JwtTokenUtil -Dlogging.level.ROOT=WARN -Dlogging.level.eu.melodic.event.util=ERROR org.springframework.boot.loader.PropertiesLauncher parser [TOKEN]
 */
@Slf4j
@SpringBootApplication
@ComponentScan(basePackages = { "eu.melodic.event.control.util.jwt", "eu.melodic.event.util", "com.ulisesbocchio" })
