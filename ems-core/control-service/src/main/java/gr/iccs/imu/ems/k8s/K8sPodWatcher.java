...
/**
 * Kubernetes cluster pods watcher
 */
@Slf4j
...
public class K8sPodWatcher implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        EMS_SERVER_POD_UID = StringUtils.defaultIfBlank(
                properties.getEmsServerPodUid(), "");
        APP_POD_LABEL = properties.getAppPodLabel();
        log.debug("K8sPodWatcher: EMS server pod: {}", EMS_SERVER_POD_UID);
        log.debug("K8sPodWatcher: App pods label: {}", APP_POD_LABEL);
    }
